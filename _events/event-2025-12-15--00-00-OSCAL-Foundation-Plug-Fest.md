...
The morning session will include a hackathon, where we invite technical experts to bring their OSCAL tools and content for a collaborative testing and interoperability workshop. One featured workstream will explore the OSCAL Mapping Model and the recent official changes to the NIST specification that the OSCAL Foundation pioneered.
